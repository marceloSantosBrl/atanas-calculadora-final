...
export const Lucro_Presumido = (Receita_Mensal, Pro_Labore, Salario_Bruto_Mensal) => {

    let Pis, Cofins, IR, Csll, Iss, Base_IR, Pis_Porcentagem, Cofins_Porcentagem, IR_Porcentagem, Csll_Porcentagem, Iss_Porcentagem, Base_IR_Porcentagem;
...
//Porcentagens Constantes
    ...
    if(Receita_Mensal <= 0){
        ...
        IR_Porcentagem = 4.8;
        Csll_Porcentagem = 2.88;
        Iss_Porcentagem = 3;
        Base_IR_Porcentagem = 32;
...
//Adicional de ir
        ...
        if(Base_IR > 20000) {
            colecao.Adicional_de_Ir = (Base_IR - 20000) * 0.1;
        }
        else {
            colecao.Adicional_de_Ir = 0;
        }
